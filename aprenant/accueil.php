...
<main class="main-acceuil-aprenant">
    ...
    <div class="parallax">
        <div class="logo-principal" data-0-top="opacity: 0; margin-left:100px" data-200-top="opacity: 1; margin-left:0px">
            <img src="../assets/img/logo-seul.png" alt="">
        </div>
        <h1 class="neon" data-0-top="opacity: 0; margin-left:100px" data-200-top="opacity: 1; margin-left:0px">Projet Open Innovation</h1>
    </div>
    ...
    <div class ="partie_2">
        ...
        <div class="pres" data-top="clip-path: inset(0% 0% 0% 0%);" data-center-center="clip-path: inset(0% 100% 0% 0%);">
            ...
            <div class="img img-2">
                <img src="../assets/img/img_accueil_4.jpg"></img>
            </div>
